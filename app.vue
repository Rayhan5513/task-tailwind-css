...
<header class="bg-white text-center p-4">
   ...
   <img src="/assets/images/headImage.png" class="w-24 h-auto mx-auto">
   
</header>

<div class="text-center">
    <h2 class="text-green-800 text-4xl font-bold ">স্বাস্থ্য, ফিটনেস এবং প্রযুক্তি সবকিছু একসাথে!</h2>
    <h2 class="text-green-800 text-4xl font-bold">"আপনার স্টাইল, আপনার স্মার্টওয়াচ।"</h2>
    <h3 class="mt-5 mb-10 px-4 bg-yellow-400 inline-block text-xl sm:text-2xl md:text-3xl lg:text-4xl">
    আপনার জীবনকে আরও স্মার্ট করুন।
</h3>

</div>

<div class="block mt-8 mx-auto relative  md:w-3/5 w-max-[85%] w-[55%] aspect-[16/9]">
  <iframe
  class="absolute w-full h-full "
    src="https://www.youtube.com/embed/hZ1DASYd9rk?si=j16WdsuKXngwwrCe"
...
<div class="flex justify-center items-center h-24 mt-12 pb-8">
    <button class="bg-green-800 text-yellow-400 px-8 py-4 flex items-center justify-center text-lg font-medium rounded-xl transition-colors duration-300 hover:bg-blue-900">
        ...
        <img src="/assets/images/clickButtonSign.png" class="w-5 h-auto ml-2">
...
<div class="bg-yellow-100 py-16">
  ...
  <div class="group border-2 border-green-800 rounded-tl-2xl rounded-br-2xl hover:bg-green-800 p-7 flex flex-col items-center min-h-[18rem]">
    ...
    <p class="text-gray-700 group-hover:text-white">
      হার্ট রেট মনিটর: দিনজুড়ে আপনার হার্টের অবস্থার নজর রাখুন।<br>
      রক্তের অক্সিজেন পর্যবেক্ষণ: SpO2 ট্র্যাকিং দিয়ে স্বাস্থ্য সম্পর্কে সচেতন থাকুন।<br>
      স্লিপ ট্র্যাকিং: গভীর ও হালকা ঘুমের স্তর বিশ্লেষণ করে সঠিক পরামর্শ।
    </p>
  </div>
  ...
  <!-- Card 3 -->
  <div class="group border-2 border-green-800 rounded-tl-2xl rounded-br-2xl hover:bg-green-800 p-7 flex flex-col items-center min-h-[18rem]">
    <h3 class="text-green-800 group-hover:text-yellow-400 font-bold mb-3 text-xl">ফিটনেস ট্র্যাকিং</h3>
    <p class="text-gray-700 group-hover:text-white">
      স্পোর্টস মোড: বিভিন্ন ধরনের স্পোর্টস অ্যাক্টিভিটির জন্য ১০+ মোড।<br>
      ক্যালোরি বার্ন কাউন্টার: আপনার ব্যায়ামের সময় ক্যালোরি খরচ নির্ধারণ করুন।<br>
      স্টেপ ট্র্যাকার: প্রতিদিনের পদক্ষেপ হিসেব করুন।
    </p>
  </div>

  <!-- Card 4 -->
  <div class="group border-2 border-green-800 rounded-tl-2xl rounded-br-2xl hover:bg-green-800 p-7 flex flex-col items-center min-h-[18rem]">
    <h3 class="text-green-800 group-hover:text-yellow-400 font-bold mb-3 text-xl ">স্মার্ট নোটিফিকেশন</h3>
    <p class="text-gray-700 group-hover:text-white">
  ...
  <!-- Card 5 -->
  <div class="group border-2 border-green-800 rounded-tl-2xl rounded-br-2xl hover:bg-green-800 p-7 flex flex-col items-center min-h-[18rem]">
    <h3 class="text-green-800 group-hover:text-yellow-400 font-bold mb-3 text-xl">দীর্ঘস্থায়ী ব্যাটারি লাইফ</h3>
    <p class="text-gray-700 group-hover:text-white">
  ...
  <!-- Card 6 -->
  <div class="group border-2 border-green-800 rounded-tl-2xl rounded-br-2xl hover:bg-green-800 p-7 flex flex-col items-center min-h-[18rem]">
    <h3 class="text-green-800 group-hover:text-yellow-400 font-bold mb-3 text-xl">মিউজিক এবং ক্যামেরা নিয়ন্ত্রণ</h3>
    <p class="text-gray-700 group-hover:text-white">
      মিউজিক চালানো বা ক্যামেরা ক্লিক করুন আপনার স্মার্টওয়াচ থেকে।<br>
      সহজ এবং সাবলীল ব্যবহারের সুবিধা।
    </p>
  </div>
</div>
...
<footer class="bg-green-900 text-white py-8">
    <div class="max-w-screen-xl mx-auto flex flex-col md:flex-row lg:flex-row justify-between items-center px-5">
        <!-- First Section: Phone -->
        <div class="flex items-center space-x-4 mb-4 md:mb-0">
            <img src="/assets/images/callImg.png" alt="Call Icon" class="w-8 h-8">
            <p class="text-left">+880 123 456 790</p>
        </div>

        <!-- Second Section: Footer Image -->
        <div class="flex justify-center md:justify-start w-full md:w-auto mb-4 md:mb-0">
            <img src="/assets/images/footerImg.png" alt="Footer Image" class="mx-auto md:mx-0">
        </div>

        <!-- Third Section: Social Media -->
        <div class="flex justify-center w-full md:w-auto">
            <img src="/assets/images/footerMedia.png" alt="Facebook Icon" class="mx-auto md:mx-0">
        </div>
    </div>

    <div class="text-center bg-green-800 py-4 mt-4">
        "© 2024 All Rights Reserved by BDFunnelBuilder. Unauthorized use prohibited."
    </div>
</footer>
